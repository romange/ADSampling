...
This repository implements the ADSampling algorithm for accelerating Distance Comparison Operations (DCOs) in high-dimensional Approximate Nearest Neighbor (ANN) search.
...
8. [Build and Usage](#build-and-usage)
9. [GIST Reproduction](#gist-reproduction)
...
* **Python dependencies** (for data preprocessing):
    * Python == 3.8
    * numpy == 1.20.3
    * faiss
